...
import es.keensoft.AikauLoginController;
...
/**
 * <p>This is to all intents and purposes the same as the es.keensoft.web.site.SlingshotUserFactory class that is used by the
...
public class AikauUserFactory extends AlfrescoUserFactory
{
    ...
    /**
     * @see es.keensoft.web.site.UserFactory#authenticate(es.keensoft.web.site.RequestContext, javax.servlet.http.HttpServletRequest, java.lang.String, java.lang.String)
     */
    @Override
